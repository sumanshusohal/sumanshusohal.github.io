...
The content and downloadable PDF are based on the AWS CIRT Security Engineer resume dated August 14, 2026. The public portfolio copy uses `sumanshu.95s@outlook.com` and omits the private phone number. Featured experience includes:
